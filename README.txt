...
1. **Create a Project**: Use the `createProject` function to initialize a new project with the required information.
2. **Fund a Project**: Users can send ether to the project using the `fundProject` function.
3. **Change Project State**: The project author can change the state using the `changeProjectState` function.
